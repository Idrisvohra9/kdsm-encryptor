        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <Card className="bg-secondary/50 backdrop-blur-md border-primary/20 text-primary">
            <CardContent className="p-6">
              ...
              <p className="text-primary/80 leading-relaxed">
                Built with Next.js 14, React 18, and optimized for
                lightning-fast encryption that scales with your needs.
          ...
          <Card className="bg-secondary/50 backdrop-blur-md border-primary/20 text-primary">
            <CardContent className="p-6">
              ...
              <p className="text-primary/80 leading-relaxed">
                Core contributors and maintainers will get hired to work
                remotely on our next project and will be paid handsomely! 💰
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-secondary/50 backdrop-blur-md border-primary/20 text-primary">
            <CardContent className="p-6">
              ...
              <p className="text-primary/80 leading-relaxed">
                Work with cutting-edge technologies: Next.js, TypeScript,
                Tailwind CSS, shadcn/ui, and Appwrite backend integration.
              </p>
            </CardContent>
          </Card>
        </div>
